...
The V3.9 production/eval source head is `eb38c78fe70d3cf9280e716f7fc906d8729b15b1`. Frozen 30-case deterministic execution, T0–T7 Dogfood, full Backend/H2, PostgreSQL 16, Frontend/Playwright, Hermes, Obsidian, sensitive-content, root launcher and ordinary same-head CI pass. The first real run `32659635453` is retained because Qwen exposed a Chapter representation defect; after the focused fix, affected rerun `32666372066` passes all three 19/19 qualifications, all three 9/9 Chapter regressions and all three 3/3 continuity suites. The 12-scenario human worksheet remains `NOT_REVIEWED`, so PR #17 stays Draft and V3.9 is not Final PASS. No Tag or Release is created.
