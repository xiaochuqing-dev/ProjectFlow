    ...
    <main className="flex min-h-screen bg-surface text-ink">
      <aside className="flex w-64 shrink-0 flex-col border-r border-line bg-elevated px-3 py-5">
        <div className="mb-7 flex items-center gap-3 px-2">
          ...
          <div>
            <p className="text-base font-semibold text-ink">ProjectFlow <span className="text-xs font-medium text-muted">V3.5.0</span></p>
            <p className="text-xs text-muted">本地优先的项目理解与记忆</p>
          </div>
        </div>
