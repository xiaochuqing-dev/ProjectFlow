...
function sourceLabel(value: string) { if (value === "MODEL_RESULT") return "完整模型分析"; if (value === "MODEL_PARTIAL_RESULT") return "部分模型恢复"; if (value === "AGENT_RESULT_DRAFT") return "Agent result 草稿"; return "本地事实草稿"; }
