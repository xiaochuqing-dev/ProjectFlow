...
- V3.9 仍处于 Draft PR 自动与人工验收阶段。三 Provider Holdout/产品场景、T0–T7 连续 Dogfood、PostgreSQL/Playwright/root launcher、同头 CI、真人 Continuity review、merge/master/backfill/cleanup 未全部完成前，不得宣布 V3.9 Final PASS 或 V3.10 ENTRY。
