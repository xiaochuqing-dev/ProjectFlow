...
Current decision: V3.8.5 is `PASS_BY_EXPLICIT_OWNER_OVERRIDE`, pending the authorized GitHub merge/backfill sequence. The pre-signoff decision below is retained as historical evidence.
