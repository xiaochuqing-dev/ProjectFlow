...
V3.3.8 keeps real DeepSeek optional because it consumes external quota. The workflow-dispatch job now executes the six-entrypoint small-input matrix. Fixed-model tests remain blocking and must never be reported as real DeepSeek evidence.
